...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`mailto:ne.premprakash53@gmail.com?subject=${subject}&body=${body}`, '_self');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className={`p-3 rounded-xl ${
                    ...
                    <svg className={`w-6 h-6 ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <p className={`text-sm opacity-75 ${theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'}`}>Phone</p>
                    <p className={`text-lg font-semibold ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'}`}>+91 6387794098</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className={`text-sm opacity-75 ${theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'}`}>Email</p>
                    <p className={`text-lg font-semibold break-all ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'}`}>ne.premprakash53@gmail.com</p>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="pt-6"
            >
              <p className={`text-sm mb-4 ${theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'} opacity-75`}>
                Connect with me
              </p>
              <div className="flex space-x-4">
                ...
                <motion.a
                  href="https://www.linkedin.com/in/premprakash-iiit/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.95 }}
                ...
                <motion.a
                  href="https://leetcode.com/u/MrCarpediem/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.95 }}
                ...
                <motion.a
                  href="https://www.instagram.com/prem.prakash4098/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.95 }}
                ...
                <motion.a
                  href="https://x.com/PREMPRA13665781"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.95 }}
