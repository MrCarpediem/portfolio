                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className={`relative w-80 h-80 md:w-96 md:h-96 rounded-3xl overflow-hidden border-2 flex items-center justify-center ${
                                theme === "dark"
                                    ? "border-[#b8f2e6]/30 bg-[#1c1c1c]"
                                    : "border-[#aed9e0]/50 bg-white"
                            }`}>
                                <div className={`text-9xl font-bold ${
                                    theme === "dark" ? "text-[#b8f2e6]/30" : "text-[#aed9e0]/40"
                                }`}>
                                    PP
                                </div>
